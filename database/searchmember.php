...
$(document).ready(function () {
          ...
          var str = '<div class="form-group" id="replace"><label class="control-label" >Enter value to be searched</label>  <div class="inputGroupContainer"><div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-search"></i></span><select  class="form-control" id="val" name="val" >' +
          '<option value="Computer Engineering"';
          if($("#val").val()=="Computer Engineering")str += 'selected';
          str +='>Computer Engineering</option>';
          str +='<option value="Mechanical Engineering"';
          if($("#val").val()=="Mechanical Engineering")str += 'selected';
          str += '>Mechanical Engineering</option>';
          str +='<option value="Electrical Engineering"';
          if($("#val").val()=="Electrical Engineering")str += 'selected';
          str += '>Electrical Engineering</option>';
          str +='<option value="Information Technology"';
          if($("#val").val()=="Information Technology")str += 'selected';
          str += '>Information Technology</option>';
          str +='<option value="Civil Engineering"';
          if($("#val").val()=="Civil Engineering")str += 'selected';
          str += '>Civil Engineering</option>';
          str +='<option value="ece"';
          if($("#val").val()=="ece")str += 'selected';
          str += '>Electonics and Communication Engineering</option>';
          str +='<option value="Agricultural Engineering"';
          if($("#val").val()=="Agricultural Engineering")str += 'selected';
          str += '>Agricultural Engineering</option>';
...
$("#replace")
    .replaceWith(' <div class="form-group" id="replace"><label class="control-label" >Enter value to be searched</label>  <div class="inputGroupContainer"><div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-search"></i></span><input name="val" id="val" placeholder="search" class="form-control"  type="text" required="required" ></div></div></div> ');
        }
    });
if($("#search").val()=="branch"){
            $("#replace").replaceWith(str);
}
});
...
//$user_name="root";
//$host_name="148.72.232.169:3306";
//$admin_password="AlumniCell@2016";
...
if(isset($_POST['search'])&&isset($_POST['val']))
  { //abhijeet wali changes
$search=$_POST['search'];
$val=$_POST['val'];
$searchterm=explode(" ",$val );
...
/// also add this by(ABHIJEET)

  $searchcol=array("fname","midname","lname");
$searchCondition=" ";
for($i=0;$i<count($searchcol);$i++)
{
$searchfieldname=$searchcol[$i];
 $searchCondition .= "($searchfieldname LIKE '%" . implode("%' OR $searchfieldname LIKE '%", $searchterm) . "%')";
        if($i+1 < count($searchcol)) $searchCondition .= " OR ";


}


$queryl="SELECT * FROM `alumni_db` WHERE $searchCondition;";
